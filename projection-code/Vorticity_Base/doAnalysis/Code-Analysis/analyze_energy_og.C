...
tuple <Double_t*, Double_t*,Double_t*, Double_t*, Double_t*, Double_t* , Double_t* >  Analyze(TFile* f, Int_t n_entries_tau_cuts){
   ...
   for(int i = 0; i < n_entries_tau_cuts; i++){
      ...
      hists_positive[i] = (TH1D*) hists_1d[i]->Clone("hists_1d[i]");
...
//Open File
   ...
   TFile* f_in_0p08 = TFile::Open("/home/joao/jbarbon/projects/Vorticity/Vorticity3D_Dev/Plots/Projections_Chun_Code/Bullets-data5/Results/Run_Energy/HB_R-.5_EtaOverS-0.08_Proj_Energy.root");
