...
void F_Generate_Gifs_th2(T2 hist, TString Name, TString path, TCanvas* c, TFile* f_in, 
...
void F_Generate_Gifs_th1(T1 hist, TString Name, TString path, TCanvas* c, TFile* f_in, 
...
void Generate_Gif(TString root_input){
    ...
    TCanvas* c1 = new TCanvas("c1", "c1", 800, 600); c1->SetGrid();
    gStyle->SetOptStat(0);
    ...
    F_Generate_Gifs_th1(Energy_x,    "energy_x",        "Bullet+BG/Energy/Proj_1D_x/Energy_tau_%.2f", c1, f_in, "" , "Energy (GeV)", -0.1, 50.0, NumberOfHistograms );
    F_Generate_Gifs_th2(Energy_xy,   "energy_xy",       "Bullet+BG/Energy/Proj_1D_yx/Energy_tau_%.2f", c1, f_in, "colz", "", -5, 50.0 , kRainBow, NumberOfHistograms);
  //  F_Generate_Gifs_th2(Energy_BG_xy,"energy_bg_xy",    "Bullet+BG/Energy/Proj_1D_yx/Energy_tau_%.2f", c1, f_in, "colz" , "", -5, 220.0 , kRainBow, NumberOfHistograms);
    F_Generate_Gifs_th2(Vorticity_xy,"vorticity_xy",    "Bullet+BG/Vorticity/Proj_1D_yx/Vorticity_tau_%.2f", c1, f_in, "surf3 FB", "", -0.22, 0.22, kRainBow, NumberOfHistograms);
    F_Generate_Gifs_th1(Vorticity_x, "vorticity_1d_x",  "Bullet+BG/Vorticity/Proj_1D_x/Vorticity_tau_%.2f", c1, f_in, "" , "Vorticity (c/fm)", -0.1, 0.6, NumberOfHistograms);
    F_Generate_Gifs_th1(Vorticity_y, "vorticity_1d_y",  "Bullet+BG/Vorticity/Proj_1D_y/Vorticity_tau_%.2f", c1, f_in, "", "Vorticity (c/fm)", -1.55, 1.55, NumberOfHistograms);
